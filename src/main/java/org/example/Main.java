...
//        menele[1].pozycjax = 1;
        ...
        while(true) {
            ...
            else if (Marek.czy_widzi_pieniadze(kasa.pozycjax, kasa.pozycjay) == 1)//jak MC nie widzi klucza to sprawdza czy widzi pieniadze
            {
                Marek.wstrone(kasa.pozycjax, kasa.pozycjay);
                if(Marek.czy_podniesie_pieniadza(kasa.pozycjax, kasa.pozycjay) == 1 && kasa.wartosc != 0)
                {
...
//            }
//            else if(policjant.czy_moze_aresztowac(Kuba.pozycjax, Kuba.pozycjay) == 1)
//                Kuba = null;
//            else
//            {
//                if(policjant.czy_widzi_dresa_lub_menela(seba.pozycjax,seba.pozycjay,rozmiar)== 1)
//                {
